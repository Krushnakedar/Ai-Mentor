  ...
  const handleDownload = async (courseId, courseTitle) => {
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/api/certificate/generate?courseId=${courseId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
                  ...
                  <div className="p-5">
                    ...
                    {course.isCompleted ? (
                      <div>
                        <button
                          onClick={() =>
                            handleDownload(course.courseId, course.courseTitle)
                          }
      ...
      {showPreview && (
        ...
        >
          ...
          <div
            ...
            style={{
              animation: "certZoomIn 0.35s cubic-bezier(0.34,1.56,0.64,1) both",
            }}
          >
            {/* Glow ring */}
            <div
            ...
            >
              ...
              <div className="p-10 text-center relative">
                ...
                <p className="text-xs text-gray-400 italic max-w-md mx-auto mb-6 leading-relaxed">
                  This certificate acknowledges the successful completion of all
                  required coursework and assessments. The recipient has
