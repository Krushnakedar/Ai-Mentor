  ...
  const handleDownload = async () => {
    try {
      ...
      const res = await fetch(
        `${API_BASE_URL}/api/certificate/generate?courseId=${selectedCourse.courseId}&enteredName=${encodedName}`,
        { headers: { Authorization: `Bearer ${token}` } },
      );
              ...
              <div className="relative bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 dark:from-indigo-950/40 dark:via-purple-950/40 dark:to-blue-950/40 flex flex-col items-center justify-center p-8 border-l border-gray-100 dark:border-gray-700">
                ...
                <div className="w-full max-w-sm bg-white dark:bg-gray-900 rounded-xl shadow-2xl border-2 border-indigo-300 dark:border-indigo-600 overflow-hidden relative">
                  ...
                  <div className="p-6 text-center">
                    ...
                    <p className="text-[10px] text-indigo-400 italic mb-4">
                ...
                <p className="mt-4 text-[11px] text-gray-400 dark:text-gray-500 text-center max-w-xs">
                  Complete any course to earn your personalized certificate like
                  this one!
                </p>
            ...
            <div className="w-full max-w-md rounded-3xl bg-white dark:bg-[#1f2937] shadow-2xl border border-gray-200 dark:border-gray-700 p-6">
              ...
              <div className="mb-4">
                ...
                <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                  Minor spelling corrections are allowed. Completely different
              ...
              <button
                ...
                disabled={downloadingId === selectedCourse?.courseId}
              ...
              >
                {downloadingId === selectedCourse?.courseId ? (
                  <>
        ...
        {showPreview && (
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              />
              <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full opacity-10 animate-pulse"
                style={{
            ...
            <div
              ...
              style={{
                animation:
                  "certZoomIn 0.35s cubic-bezier(0.34,1.56,0.64,1) both",
              }}
            >
              {/* Glow ring */}
              <div
              ...
              <div
                ...
                onMouseMove={(e) => {
                  ...
                  card.__tiltFrame = requestAnimationFrame(() => {
                    ...
                    const x =
                      ((pointer.clientX - rect.left) / rect.width - 0.5) * 18;
                    const y =
                      ((pointer.clientY - rect.top) / rect.height - 0.5) * -18;
              ...
              >
                ...
                <div className="p-10 text-center relative">
                  ...
                  {/* Title */}
                  <h2
                    className="text-3xl font-bold text-gray-800 mb-1 tracking-wide"
                  ...
                  <p
                    className="text-2xl font-extrabold text-gray-800 mb-1 italic"
                    style={{ fontFamily: "Georgia, serif" }}
                  >
                    Your Name
                  </p>
                  ...
                  <p className="text-xs text-gray-400 italic max-w-md mx-auto mb-6 leading-relaxed">
                    This certificate acknowledges the successful completion of
                    all required coursework and assessments. The recipient has
                  ...
                  <div className="mt-4 pt-5 border-t border-gray-100 flex justify-between items-end">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-[9px] font-bold text-indigo-400 mt-1 tracking-widest uppercase">
                        Verified & Authentic
                      </p>
                      ...
                      <div className="mt-1.5 w-10 h-10 ml-auto border border-gray-200 rounded flex items-center justify-center bg-gray-50">
                        <div className="grid grid-cols-3 gap-px w-6 h-6">
                          {Array.from({ length: 9 }).map((_, i) => (
                            <div
                              key={i}
                              className={`rounded-[1px] ${[0, 1, 3, 5, 7, 8].includes(i) ? "bg-gray-700" : "bg-transparent"}`}
                            />
                          ))}
                        </div>
                      </div>
              ...
              <p className="text-center text-white/40 text-xs mt-4 tracking-wide">
                🏆 This is a preview of the certificate you&apos;ll receive upon
                completing a course
              </p>
            </div>
